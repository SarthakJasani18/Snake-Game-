...
public class ViewManager {
    ...
    public void initalizeMainMenu() {
        ...
        primaryStage.setTitle("Snake Game project");
        primaryStage.show();
    }
    ...
    private void initStartSubScene() {
        mainSubScene = new AdvancedSnakeSubScene("resources/views/res/");
        ...
        welcomeText.setText("Welcome to Snake Game \n" +
        		"Press 'Settings' to select difficulty, \n" +
        		" and implement bonus apples and more. \n" +
        		"Under 'Score' you can see your HighScore.\n\n" +
        		"Use the arrow keys to move the snake, 'P'\n" +
        		"pauses and 'Tab' starts over.\n" +
        		 "'Esc' is used to return to the menu\n" +
        		 "Bonus apples:");
        ...
        brownAppleText.setText("Placing\n" +
                "walls on the \n" +
                "\n" +
                "5 Point");
    ...
    private void initScoreSubScene() {
        scoreSubScene = new AdvancedSnakeSubScene("resources/views/res/");
    ...
    private void initSettingSubScene() {
        settingSubScene = new AdvancedSnakeSubScene("resources/views/res/");
        ...
        Label powerDescription = new Label("Turn bonus apples on or off");
        makeLabel(powerDescription, 250, 203);
        Label easyDescription = new Label("Normal game speed and no wall");
        makeLabel(easyDescription,250, 253);
        Label normalDescription = new Label("Normal game speed and wall");
        makeLabel(normalDescription, 250, 283);
        Label hardDescription = new Label("Fast game speed and wall");
        makeLabel(hardDescription, 250, 313);

        inputGridSizeX = new TextField();
        inputGridSizeX.setPromptText("Insert width(5 - 100)");
        inputGridSizeX.setLayoutX(100);
        inputGridSizeX.setLayoutY(100);
        inputGridSizeY = new TextField();
        inputGridSizeY.setPromptText("Insert Height(5 - 100)");
    ...
    public void initGameStage() {
        gameStage = new Stage();
        gameStage.setTitle("Sanke Game Project");
